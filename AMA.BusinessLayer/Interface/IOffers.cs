...
namespace AMA.BusinessLayer.Interface
{
    ...
    {
        Task<List<SP_GET_OfferProducts_Search_Paging_Sorting_Result>> GetOfferProductsBySP(string searchText, string productBrand, string attributes, int? categoryId, string macId, int? pageNbr, int? pageSize, string sortCol, ILog log = null);
