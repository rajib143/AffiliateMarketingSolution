...
namespace AMA.DataLayer.Data
{
    public interface ILootLoOnlineEntity
    {
        ...
        Task<List<SP_GET_OfferProducts_Search_Paging_Sorting_Result>> GetOfferProductsBySP(string searchText, string productBrand, string attributes, Nullable<int> categoryId, string macId, Nullable<int> pageNbr, Nullable<int> pageSize, string sortCol, ILog log = null);
